...
namespace NTR.Common.DataAccess.UnitTest.Options.ConnectionStringTests
{
    public class ToStringTests
    {
        ...
        private void HostIsAssignedToServer()
        {
            ...
            Assert.Contains("Server=host, 1234;Database=db;User Id=user;Password=pwd;", conn.ToString());
        }
